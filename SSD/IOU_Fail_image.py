...
for image in list_image:
	...
	#count = count + 1
	#try:
	    image_path = '/media/biometric/Data1/Ranjeet/NewPytorch/SSD_Ear_RGB_300/miscases/' + image[0]
	    print(image_path)
	    ...
	    for box in boxes:
	        ...
	        if(IOU<0.9):
	        	...
	        	img.save('/media/biometric/Data1/Ranjeet/NewPytorch/SSD_Ear_RGB_300/SSD_Fail_Case/' + image[0])
