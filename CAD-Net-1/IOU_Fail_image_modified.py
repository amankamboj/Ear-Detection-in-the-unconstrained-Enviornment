...
# Load model
net = SSD300()
checkpoint = torch.load('/media/biometric/Data1/Ranjeet/NewPytorch/Headless_300/checkpoint/ckpt.pth')
...
iou_path_Ear = open('iou_new_data_ssh.txt_fail_new1', 'w+')

testdata = 'new_data.txt'
...
for image in list_image:
	...
	try:
	    ...
	    for box in boxes:
	        ...
	        cv2.rectangle(img,(predict_box[0],predict_box[1]), (predict_box[2], predict_box[3]),(0, 0, 255),4)
	        print("====saving file========")
		    #cv2.rectangle(img,(x1_p, y1_p), (x2_p, y2_p), (255, 0, 0),4)
	        img.save('/media/biometric/Data1/Ranjeet/NewPytorch/Headless_300/Challange_results1/' + image[0])
