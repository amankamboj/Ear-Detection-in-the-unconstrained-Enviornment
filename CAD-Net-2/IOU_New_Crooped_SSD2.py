...
iou_path_Ear = open('IOU_Cropped_GT_Ear_SSD2_UBEAR2.txt', 'w+')

testdata = 'Mis_Cropped_UBEAR1.txt'
...
for image in list_image:
	...
	#count = count + 1
	try:
	    image_path = '/media/biometric/Data1/Ranjeet/NewPytorch/SSD_Ear_RGB_300/New_cropped1/' + image[0]
	    ...
	    for box in boxes:
	        ...
	        img.save('/media/biometric/Data1/Ranjeet/NewPytorch/SSD_Ear_RGB_300/Challange_results_SSD2/' + image[0])
